---
title: "技能与 Agent SDK —— Anthropic Skills、AGENTS.md、OpenAI Apps SDK"
type: 学习
phase: "13-tools-and-protocols"
chapter: "22"
language: "Python（标准库，SKILL.md 解析器和加载器）"
prerequisites: [[[13-tools-and-protocols/07_building-an-mcp-server]]]
tags: [理论学习, 环境工具]
created: 2026-05-26
updated: 2026-05-26
---
