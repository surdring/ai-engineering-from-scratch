---
title: "MCP Apps —— 通过 `ui://` 的交互式 UI 资源"
type: 构建
phase: "13-tools-and-protocols"
chapter: "14"
language: "Python（标准库，UI 资源发射器），HTML（示例应用）"
prerequisites: [[[13-tools-and-protocols/07_building-an-mcp-server]], [[13-tools-and-protocols/10_mcp-resources-and-prompts]]]
tags: [实操, 环境工具]
created: 2026-05-26
updated: 2026-05-26
---
...
- [[13-tools-and-protocols/10_mcp-resources-and-prompts]]
